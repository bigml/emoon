...
vec3 vec3_min_vec3(vec3 v1, vec3 v2) {
    vec3 v;
    v.x = min(v1.x, v2.x);
    v.y = min(v1.y, v2.y);
    v.z = min(v1.z, v2.z);
...
vec3 vec3_min_vec3_abs(vec3 v1, vec3 v2) {
    vec3 v;
    v.x = fabs(v1.x) < fabs(v2.x) ? v1.x : v2.x;
    v.y = fabs(v1.y) < fabs(v2.y) ? v1.y : v2.y;
    v.z = fabs(v1.z) < fabs(v2.z) ? v1.z : v2.z;

    v.x = v.x * v1.x >= 0 ? v.x : -v.x;
    v.y = v.y * v1.y >= 0 ? v.y : -v.y;
    v.z = v.z * v1.z >= 0 ? v.z : -v.z;
    return v;
}

vec3 vec3_max_vec3(vec3 v1, vec3 v2) {
    vec3 v;
    v.x = max(v1.x, v2.x);
    v.y = max(v1.y, v2.y);
    v.z = max(v1.z, v2.z);
...
vec3 vec3_max_vec3_abs(vec3 v1, vec3 v2) {
    vec3 v;
    v.x = fabs(v1.x) > fabs(v2.x) ? v1.x : v2.x;
    v.y = fabs(v1.y) > fabs(v2.y) ? v1.y : v2.y;
    v.z = fabs(v1.z) > fabs(v2.z) ? v1.z : v2.z;
...
void vec4_print(vec4 v) {
  printf("vec4(%4.2f, %4.2f, %4.2f, %4.2f)\n", v.x, v.y, v.z,  v.w);
}
