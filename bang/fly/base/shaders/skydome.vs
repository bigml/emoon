...
const vec3 inv_wavelength = vec3(0.620, 0.495, 0.475);
...
const float kr4pi = kr * 4.0 * 3.141;
const float km4pi = km * 4.0 * 3.141;
...
void main() {
  ...
  cam_pos.y = cam_pos.y / 2048.0 + inner_radius;
  cam_pos.xz = (cam_pos.xz - 512.0) / 2048.0;
